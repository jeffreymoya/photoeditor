...
try {
  ...
  markdown += '- [ ] **Contract tests** pass: `npm run test:contracts`\n';
  ...
  markdown += '2. Run compatibility tests: `npm run test:contracts`\n';
  markdown += '3. Update snapshot if intentional: `npm run contracts:check -- --update`\n';
  ...
  markdown += '- [Testing Standards](docs/testing-standards.md)\n\n';
